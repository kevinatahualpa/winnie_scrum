...
from .views import (
    ...
    ver_tablero, ver_usuarios, ver_servicios, ver_clientes, ver_areas, ver_especialidades,
    ...
    ver_backlog, ver_sprints, ver_documentos, ver_calendario,
    ver_pendientes, ver_configuracion, crear_sprint, iniciar_sprint,
    completar_sprint, seleccionar_tareas_sprint, editar_sprint, eliminar_sprint, subir_documento,
...
urlpatterns = [
    ...
    path('reset-password/<str:uidb64>/<str:token>/', resetear_password, name='resetear_password'),
    ...
    path('ver_usuarios/create/', registrar_usuario, name='registrar_usuario'),
    path('ver_usuarios/<int:pk>/edit/', editar_usuario, name='editar_usuario'),
    path('ver_usuarios/<int:pk>/deactivate/', desactivar_usuario, name='desactivar_usuario'),
    path('ver_usuarios/<int:pk>/reactivate/', reactivar_usuario, name='reactivar_usuario'),
    path('ver_usuarios/desactivados/', ver_usuarios_desactivados, name='ver_usuarios_desactivados'),
