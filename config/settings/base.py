...
MIDDLEWARE = [
    ...
    'apps.core.presentation.middleware.SingleSessionMiddleware',
]
...
if DATABASE_URL:
    DATABASES = {
        'default': dj_database_url.config(default=DATABASE_URL, conn_max_age=3600, conn_health_checks=True)
    }
else:
    DATABASES = {
        'default': {
...
if os.getenv('RESEND_API_KEY'):
    ...
    EMAIL_HOST_PASSWORD = ''
EMAIL_TIMEOUT = 5
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Winnie <noreply@winniepm.xyz>')
